export const projects = [
  ...
  },
  {
    ...
    gallery: [
      { type: 'image', src: '/winnerandy.jpg', alt: 'Tournament battle bot winning team', caption: 'Tournament Winners' },
      { type: 'image', src: '/andy.jpg', alt: 'Tournament battle bot', caption: '"ANDY" — competition-ready' },
      { type: 'video', src: '/fight1.mov', caption: 'Combat Match 1' },
      { type: 'video', src: '/fight2.mov', caption: 'Combat Match 2' },
      { type: 'video', src: '/fight3.mov', caption: 'Combat Match 3' },
    ],
  },
];
